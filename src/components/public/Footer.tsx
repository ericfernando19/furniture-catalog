          ...
          <div>
            ...
            <div className="mt-3 flex flex-col gap-3">
              <a
                ...
                className="flex items-center gap-2 text-sm text-[#4A3728] transition-colors hover:text-[#8B6914] dark:text-gray-400"
              >
              ...
              <div className="flex items-start gap-2 text-sm text-[#4A3728] dark:text-gray-400">
